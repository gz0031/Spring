package priv.ze.spring.Mybatis.test;
...
public class Test1 {
    ...
    @Before
    public void before() {
        String resource = "priv/ze/spring/Mybatis/applicationContext.xml";
    ...
    @Test
        public void  test01() {
        Student student = new Student("李四", 23);
    ...
    @Test
    public void test05(){
        String name=studentService.findStudentNameById(11);
